...
- If you do not have a laptop log in to the VM as soon as you can and get everything running.
- Commit your work to GitHub regularly just in case anything happens. Try to build a commit history of at least 10 to 15 with nice commit messages.
- Make sure to have all apps up to date.
- Have back up emulators available to you such as bluestacks and multiple virtual devices all installed and ready to go.
- Make sure that GitHub works for you.
- Ensure that GitHub desktop works for you on both your local machine as well as your VM.
